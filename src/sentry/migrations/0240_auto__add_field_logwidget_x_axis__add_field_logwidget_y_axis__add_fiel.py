...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogWidget.x_axis'
        db.add_column('sentry_widget', 'x_axis',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'LogWidget.y_axis'
        db.add_column('sentry_widget', 'y_axis',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'LogWidget.chart_type'
        db.add_column('sentry_widget', 'chart_type',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogWidget.x_axis'
        db.delete_column('sentry_widget', 'x_axis')

        # Deleting field 'LogWidget.y_axis'
        db.delete_column('sentry_widget', 'y_axis')

        # Deleting field 'LogWidget.chart_type'
        db.delete_column('sentry_widget', 'chart_type')
