...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogInsightDashboard.layout'
        db.alter_column(u'sentry_loginsight_dashboard', 'layout', self.gf('django.db.models.fields.CharField')(max_length=524288, null=True))

    def backwards(self, orm):

        # Changing field 'LogInsightDashboard.layout'
        db.alter_column(u'sentry_loginsight_dashboard', 'layout', self.gf('django.db.models.fields.CharField')(default={'xxx': 'yyy'}, max_length=524288))
