...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.organization'
        db.add_column(u'sentry_host', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['sentry.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.organization'
        db.delete_column(u'sentry_host', 'organization_id')
