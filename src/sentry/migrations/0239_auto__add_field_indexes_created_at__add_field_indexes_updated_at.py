...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indexes.created_at'
        db.add_column(u'sentry_indexes', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 2, 0, 0), null=True),
                      keep_default=False)

        # Adding field 'Indexes.updated_at'
        db.add_column(u'sentry_indexes', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 2, 0, 0), null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indexes.created_at'
        db.delete_column(u'sentry_indexes', 'created_at')

        # Deleting field 'Indexes.updated_at'
        db.delete_column(u'sentry_indexes', 'updated_at')
