...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.create_time'
        db.add_column(u'sentry_host', 'create_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Host.last_time'
        db.add_column(u'sentry_host', 'last_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.create_time'
        db.delete_column(u'sentry_host', 'create_time')

        # Deleting field 'Host.last_time'
        db.delete_column(u'sentry_host', 'last_time')
    ...
    models = {
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
