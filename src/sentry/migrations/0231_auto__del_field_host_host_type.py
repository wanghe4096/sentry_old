...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'sentry_host', 'host_type_id')


    def backwards(self, orm):
        # Adding field 'Host.host_type'
        db.add_column(u'sentry_host', 'host_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sentry.HostType']),
                      keep_default=False)
