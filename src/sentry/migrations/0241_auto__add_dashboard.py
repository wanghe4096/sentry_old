...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sentry_dashboard', (
            ...
            ('updated_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 1, 0, 0), null=True)),
        ...
        db.send_create_signal(u'sentry', ['Dashboard'])
    ...
    models = {
        ...
        u'sentry.dashboard': {
            ...
            'updated_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 1, 0, 0)', 'null': 'True'}),
