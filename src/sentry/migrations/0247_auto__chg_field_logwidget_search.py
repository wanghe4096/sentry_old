...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogWidget.search'
        db.alter_column('sentry_widget', 'search_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Search'], null=True))

    def backwards(self, orm):

        # Changing field 'LogWidget.search'
        db.alter_column('sentry_widget', 'search_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sentry.Search']))
