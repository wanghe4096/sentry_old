...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'sentry_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.User'])),
        ))
        db.send_create_signal(u'sentry', ['Tag'])

        # Adding model 'LogEvent'
        db.create_table(u'sentry_log_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payload', self.gf('django.db.models.fields.CharField')(max_length=65536)),
            ('offset', self.gf('django.db.models.fields.IntegerField')()),
            ('stream', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Stream'])),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Host'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.User'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Tag'], null=True)),
        ))
        db.send_create_signal(u'sentry', ['LogEvent'])

        # Adding model 'StreamType'
        db.create_table(u'sentry_stream_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stream_type', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.User'])),
        ))
        db.send_create_signal(u'sentry', ['StreamType'])

        # Adding model 'Stream'
        db.create_table(u'sentry_stream', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stream_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('stream_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.StreamType'])),
            ('size', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('modify_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('create_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Tag'], null=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Host'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.User'])),
        ))
        db.send_create_signal(u'sentry', ['Stream'])

        # Adding model 'Host'
        db.create_table(u'sentry_host', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('host_key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('system', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('distver', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('host_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.HostType'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.User'])),
        ))
        db.send_create_signal(u'sentry', ['Host'])

        # Adding model 'HostType'
        db.create_table(u'sentry_host_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host_type', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.User'])),
        ))
        db.send_create_signal(u'sentry', ['HostType'])


    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'sentry_tag')

        # Deleting model 'LogEvent'
        db.delete_table(u'sentry_log_event')

        # Deleting model 'StreamType'
        db.delete_table(u'sentry_stream_type')

        # Deleting model 'Stream'
        db.delete_table(u'sentry_stream')

        # Deleting model 'Host'
        db.delete_table(u'sentry_host')

        # Deleting model 'HostType'
        db.delete_table(u'sentry_host_type')
    ...
    models = {
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        u'sentry.host': {
            ...
            'host_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sentry.HostType']"}),
        ...
        u'sentry.hosttype': {
            ...
            'host_type': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sentry.User']"})
        },
        u'sentry.logevent': {
            ...
            'stream': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sentry.Stream']"}),
        ...
        u'sentry.stream': {
            ...
            'stream_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sentry.StreamType']"}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sentry.Tag']", 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sentry.User']"})
        },
        u'sentry.streamtype': {
