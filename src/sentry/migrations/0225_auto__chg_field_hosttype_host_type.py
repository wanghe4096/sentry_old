...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HostType.host_type'
        db.alter_column(u'sentry_host_type', 'host_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'HostType.host_type'
        db.alter_column(u'sentry_host_type', 'host_type', self.gf('django.db.models.fields.CharField')(default='mysql', max_length=128))
