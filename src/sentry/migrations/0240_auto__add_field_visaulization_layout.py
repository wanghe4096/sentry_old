...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visaulization.layout'
        db.add_column(u'sentry_visualization', 'layout',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visaulization.layout'
        db.delete_column(u'sentry_visualization', 'layout')
