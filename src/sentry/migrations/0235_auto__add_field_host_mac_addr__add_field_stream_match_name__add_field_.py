...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.mac_addr'
        db.add_column(u'sentry_host', 'mac_addr',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)

        # Adding field 'Stream.match_name'
        db.add_column(u'sentry_stream', 'match_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)

        # Adding field 'Stream.stream_key'
        db.add_column(u'sentry_stream', 'stream_key',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)

        # Adding field 'Stream.alias_name'
        db.add_column(u'sentry_stream', 'alias_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.mac_addr'
        db.delete_column(u'sentry_host', 'mac_addr')

        # Deleting field 'Stream.match_name'
        db.delete_column(u'sentry_stream', 'match_name')

        # Deleting field 'Stream.stream_key'
        db.delete_column(u'sentry_stream', 'stream_key')

        # Deleting field 'Stream.alias_name'
        db.delete_column(u'sentry_stream', 'alias_name')
