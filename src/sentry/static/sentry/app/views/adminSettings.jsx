    ...
    return (
      <div>
        ...
        :
          <div>
            {submitError &&
              <div className="alert alert-block alert-error">{t('We were unable to submit your changes to the Loginsight server. Please take a look at the service logs.')}</div>
            }
            <SettingsList
                options={options}
