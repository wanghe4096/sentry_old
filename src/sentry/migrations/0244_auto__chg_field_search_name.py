...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Search.name'
        db.alter_column('sentry_search', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Search.name'
        db.alter_column('sentry_search', 'name', self.gf('django.db.models.fields.CharField')(default='aaa', max_length=1024))
