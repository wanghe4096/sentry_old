...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogWidget.title'
        db.alter_column('sentry_widget', 'title', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'LogWidget.title'
        db.alter_column('sentry_widget', 'title', self.gf('django.db.models.fields.CharField')(default='f', max_length=512))
