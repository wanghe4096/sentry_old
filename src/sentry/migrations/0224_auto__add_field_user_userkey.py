...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.userkey'
        db.add_column('auth_user', 'userkey',
                      self.gf('django.db.models.fields.CharField')(max_length=128, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.userkey'
        db.delete_column('auth_user', 'userkey')
    ...
    models = {
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
