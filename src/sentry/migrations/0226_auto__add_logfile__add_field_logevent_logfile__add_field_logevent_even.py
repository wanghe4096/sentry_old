...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sentry_log_file', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('file_path', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('stream_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Host'], null=True)),
            ...
            ('mod', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('size', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('crc32_value', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal(u'sentry', ['LogFile'])

        # Adding field 'LogEvent.logfile'
        db.add_column(u'sentry_log_event', 'logfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.LogFile'], null=True),
                      keep_default=False)

        # Adding field 'LogEvent.event_no'
        db.add_column(u'sentry_log_event', 'event_no',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'LogEvent.stream'
        db.alter_column(u'sentry_log_event', 'stream_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Stream'], null=True))

    def backwards(self, orm):
        # Deleting model 'LogFile'
        db.delete_table(u'sentry_log_file')

        # Deleting field 'LogEvent.logfile'
        db.delete_column(u'sentry_log_event', 'logfile_id')

        # Deleting field 'LogEvent.event_no'
        db.delete_column(u'sentry_log_event', 'event_no')


        # Changing field 'LogEvent.stream'
        db.alter_column(u'sentry_log_event', 'stream_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sentry.Stream']))
