...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogWidget.created_at'
        db.add_column('sentry_widget', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 2, 0, 0)),
                      keep_default=False)

        # Adding field 'LogWidget.updated_at'
        db.add_column('sentry_widget', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogWidget.created_at'
        db.delete_column('sentry_widget', 'created_at')

        # Deleting field 'LogWidget.updated_at'
        db.delete_column('sentry_widget', 'updated_at')
    ...
    models = {
        ...
        'sentry.logwidget': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 2, 0, 0)'}),
            'desc': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 2, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sentry.User']"}),
