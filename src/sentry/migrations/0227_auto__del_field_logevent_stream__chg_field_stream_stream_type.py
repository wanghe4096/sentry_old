...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LogEvent.stream'
        db.delete_column(u'sentry_log_event', 'stream_id')


        # Changing field 'Stream.stream_type'
        db.alter_column(u'sentry_stream', 'stream_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.StreamType'], null=True))

    def backwards(self, orm):
        # Adding field 'LogEvent.stream'
        db.add_column(u'sentry_log_event', 'stream',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Stream'], null=True),
                      keep_default=False)


        # Changing field 'Stream.stream_type'
        db.alter_column(u'sentry_stream', 'stream_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sentry.StreamType']))
